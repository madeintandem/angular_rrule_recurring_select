    ...
    link: function(scope, elem, attrs) {
      ...
      scope.initFromRecurEndRule = function() {
        ...
        if (scope.recurrenceRule.options.until) {
          ...
          if (scope.recurrenceRule.options.until.constructor.name === 'TimeZoneDate') {
